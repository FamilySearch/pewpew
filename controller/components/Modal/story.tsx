...
import { ProviderListEntry } from "../../types/yamlwriter";
      ...
      <HeaderMain>
        ...
        >
          <div style={{ color: "rgb(242, 241, 239)" }}>
            Drag file to drop zone or click to select file to load. Currently will only load one
            file at a time.
          </div>
                ...
                return (
                  <tr key={index}>
                    <td className="tableButton">
                      <button id="providerList" name="list item" value={item.id}>
                        X
                      </button>
                    </td>
    ...
    <div>
      ...
      <DisplayDivMain>
        ...
        >
          <Label>
            File Name:&nbsp;
            <input style={{ width: "150px" }} onChange={changeFileName} value="" />
            .yaml
          </Label>
        </Modal>
      </DisplayDivMain>
...
export const UploadHarModal = () => <ModalUploadHarDemo />;

export const ListModal = () => <ModalListDemo />;

export const _LoggerModal = () => <ModalLoggerDemo />;

export const CreateYamlModal = () => <ModalCreateYamlDemo />;
