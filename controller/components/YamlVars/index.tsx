    ...
    <InputsDiv>
      ...
      <Div>
        <Span>
          ...
          <Checkbox type="checkbox" id={sessionId} onChange={(event: React.ChangeEvent<HTMLInputElement>) => switchDefault(sessionId, event.target.checked)} checked={state.sessionId}/>
        </Span>
        <Span>
          <Label htmlFor={rampTime}> ramptime: </Label>
          <QuestionBubble text="rampTime included"></QuestionBubble>
          <Checkbox type="checkbox" id={rampTime} onChange={(event: React.ChangeEvent<HTMLInputElement>) => switchDefault(rampTime, event.target.checked)} checked={state.rampTime}/>
        </Span>
        <Span>
          <Label htmlFor={loadTime}> loadtime: </Label>
          <QuestionBubble text="loadTime included"></QuestionBubble>
          <Checkbox type="checkbox" id={loadTime} onChange={(event: React.ChangeEvent<HTMLInputElement>) => switchDefault(loadTime, event.target.checked)} checked={state.loadTime}/>
        </Span>
        <Span>
          <Label htmlFor={peakLoad}> peakload: </Label>
          <QuestionBubble text="peakLoad included"></QuestionBubble>
          <Checkbox type="checkbox" id={peakLoad} onChange={(event: React.ChangeEvent<HTMLInputElement>) => switchDefault(peakLoad, event.target.checked)} checked={state.peakLoad}/>
        </Span>
        <div>
          <Span>
