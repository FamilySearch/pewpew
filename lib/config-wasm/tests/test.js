...
const suite = describe("config-wasm", () => {
  ...
  it("should throw error on empty yaml", (done) => {
    try {
      config = new Config(Buffer.from("", "utf-8"), varMap);
      config.checkOk();
      console.log(config.getBucketSize(), "getBucketSize")
      console.log(config.getDuration(), "getDuration");
      console.log(config.getInputFiles(), "getInputFiles");
      console.log(config.getLoggerFiles(), "getLoggerFiles");
  ...
  it("should throw error on json file", (done) => {
    try {
      config = new Config(Buffer.from(`{"message":"Test file to upload."}`, "utf-8"), varMap);
      config.checkOk();
      console.log(config.getBucketSize(), "getBucketSize")
      console.log(config.getDuration(), "getDuration");
      console.log(config.getInputFiles(), "getInputFiles");
